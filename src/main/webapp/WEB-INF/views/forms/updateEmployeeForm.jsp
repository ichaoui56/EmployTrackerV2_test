...
<layout:dashboardLayout title="EmployeeTracker | UPDATE EMPLOYEE">
    <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl mb-12">
        <nav navbar-main
                ...
                <nav>
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li
                                ...
                                aria-current="page">Update Employee
                        </li>
                    </ol>
                    <h6 class="mb-0 font-bold text-white capitalize">Update Employee</h6>
                </nav>
                        ...
                        <div class="flex flex-wrap -mx-3">
                            <div class="w-full max-w-full px-3 m-auto flex-0 lg:w-8/12">
                                <form action="employee" method="POST" class="relative mb-32">
                                    ...
                                    <div class="absolute top-0 left-0 flex flex-col visible w-full h-auto min-w-0 p-4 break-words bg-white border-0 shadow-xl opacity-100 dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                                        ...
                                        <div class="flex flex-wrap mt-4 -mx-3">
                                            ...
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="name" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Name</label>
                                                <input type="text" value="${employee.name}" id="name" name="name" placeholder="Enter employee's name" required
                                            ...
                                            <!-- Email Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="email" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Email</label>
                                                <input type="email" id="email" value="${employee.email}" name="email" placeholder="Enter employee's email" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap mt-4 -mx-3">
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="password" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Password:</label>
                                                <input type="password" value="${employee.password}" id="password" name="password" placeholder="Enter employee's password" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="childNumber" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Number of Children</label>
                                                <input type="number" id="childNumber" name="childNumber" value="${employee.childNumber}" placeholder="Enter number of children" required min="0"
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap -mx-3">
                                            <!-- Social Number Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="socialNumber" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Social Number</label>
                                                <input type="text" value="${employee.socialNumber}" id="socialNumber" name="socialNumber" placeholder="Enter social security number" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>

                                            <!-- Department Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="department" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Department</label>
                                                <input type="text" id="department" value="${employee.department}" name="department" placeholder="Enter department" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap -mx-3">
                                            <!-- Poste Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="poste" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Poste</label>
                                                <input type="text" id="poste" value="${employee.poste}" name="poste" placeholder="Enter poste" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>

                                            <!-- Salary Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="salary" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Salary</label>
                                                <input type="number" id="salary" value="${employee.salary}" name="salary" placeholder="Enter salary" required min="0"
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex flex-wrap -mx-3">
                                            <!-- Birth Date Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="birthDate" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Birth Date</label>
                                                <input type="date" id="birthDate" value="${employee.birthDate}" name="birthDate" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>

                                            <!-- Start Date Field -->
                                            <div class="w-full max-w-full px-3 flex-0 sm:w-6/12">
                                                <label for="startDate" class="mt-6 mb-2 ml-1 text-xs font-bold text-slate-700 dark:text-white/80">Start Date</label>
                                                <input type="date" id="startDate" name="startDate" value="${employee.startDate}" required
                                                       class="focus:shadow-primary-outline dark:bg-slate-850 dark:placeholder:text-white/80 dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                            </div>
                                        </div>
