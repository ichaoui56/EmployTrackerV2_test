...
<!-- Mirrored from shreethemes.in/jobnova/layouts/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Oct 2024 16:29:04 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
<!-- Start Hero -->
<section class="bg-home d-flex align-items-center" style="background: url('assets/images/hero/bg3.jpg') center;">
            ...
            <div class="col-12">
                <div class="p-4 bg-white rounded shadow-md mx-auto w-100" style="max-width: 400px;">
                    <form action="auth" method="post">
                        <a href="index.html"><img src="assets/images/logo-dark.png" class="mb-4 d-block mx-auto" alt=""></a>
