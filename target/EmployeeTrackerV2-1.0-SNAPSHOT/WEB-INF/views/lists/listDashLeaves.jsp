                    ...
                    <c:forEach var="leave" items="${leaves}">
                        <div class="w-full max-w-full px-3 mb-6 md:flex-0 shrink-0 md:w-6/12 lg:w-4/12">
                            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                                <div class="flex-auto p-4 overflow-auto" style="height: 200px; scrollbar-width: none;">
                                    <div class="flex justify-between">
                                        <div class="my-auto ml-4">
                                            <h6 class="dark:text-white text-center">${leave.employee.name}</h6>
                                        </div>
                                        ...
                                        <form action="leave" method="post" id="statusForm">
                                            ...
                                            <select name="status" class="custom-select" onchange="this.form.submit()">
                                                <c:forEach var="status" items="${status}">
                                                    <!-- Mark the current leave status as selected -->
                                                    <option value="${status}" ${leave.status == status ? 'selected' : ''}>${status}</option>
                                                </c:forEach>
                                            </select><br><br>
                                        </form>
                                    </div>
                                    ...
                                    <!-- Leave details -->
                                    <div class="">
                                        <p><strong>Leave Reason: </strong></p>
                                        <p class="mt-1 text-sm leading-normal">${leave.leaveReason}</p>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-6/12 max-w-full px-3 flex-0">
                                            <p class="mb-0 text-sm font-semibold leading-normal text-slate-400">
                                                Period:</p>
                                            <h6 class="mb-0 text-sm leading-normal">${leave.periode}</h6>
                                        </div>
                                        <div class="w-6/12 max-w-full px-3 text-right flex-0">
                                            <p class="mb-0 text-sm font-semibold leading-normal text-slate-400">Leave
                                                date:</p>
                                            <h6 class="mb-0 text-sm leading-normal">${leave.leaveDate}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
