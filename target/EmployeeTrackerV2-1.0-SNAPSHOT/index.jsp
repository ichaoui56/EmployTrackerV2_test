...
<layout:homeLayout title="EmployeeTracker | Home">
  <!-- Hero Start -->
  <section class="bg-half-260 d-table w-100" style="background: url('assets/images/hero/bg.jpg');">
      ...
      <div class="row mt-5 justify-content-center">
        <div class="col-lg-10">
          <div class="title-heading text-center">
            ...
            <p class="para-desc text-white-50 mx-auto mb-0">Find Jobs, Employment & Career Opportunities. Some
              of the companies we've helped recruit excellent applicants over the years.</p>
          ...
          <div class="tiny-five-item">
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/01.jpg" class="img-fluid" alt="">
            ...
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/02.jpg" class="img-fluid" alt="">
                    <div class="card-overlay"></div>
                  </div>
            ...
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/03.jpg" class="img-fluid" alt="">
                    <div class="card-overlay"></div>
                  </div>
            ...
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/04.jpg" class="img-fluid" alt="">
                    <div class="card-overlay"></div>
                  </div>
            ...
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/05.jpg" class="img-fluid" alt="">
                    <div class="card-overlay"></div>
                  </div>
            ...
            <div class="tiny-slide">
              <div class="card features rounded shadow position-relative overflow-hidden m-2">
                <div class="card-body p-0">
                  <div class="card-img">
                    <img src="assets/images/work/06.jpg" class="img-fluid" alt="">
                    <div class="card-overlay"></div>
                  </div>
        ...
        <div class="col-lg-6 col-md-6 mb-5">
          <div class="about-left">
            <div class="position-relative shadow rounded img-one">
              <img src="assets/images/about/ab01.jpg" class="img-fluid rounded" alt="work-image">
            </div>

            <div class="img-two shadow rounded p-2 bg-white">
              <img src="assets/images/about/ab02.jpg" class="img-fluid rounded" alt="work-image">
          ...
          <div class="section-title ms-lg-5">
            ...
            <ul class="list-unstyled text-muted mb-0 mt-3">
              <li class="mb-1"><span class="text-primary h5 me-2"><i
                      class="mdi mdi-check-circle-outline align-middle"></i></span>Digital Marketing Solutions
                for Tomorrow
              </li>
              <li class="mb-1"><span class="text-primary h5 me-2"><i
                      class="mdi mdi-check-circle-outline align-middle"></i></span>Our Talented & Experienced
                Marketing Agency
              </li>
              <li class="mb-1"><span class="text-primary h5 me-2"><i
                      class="mdi mdi-check-circle-outline align-middle"></i></span>Create your own skin to
                match your brand
              </li>
            </ul>
    ...
    <div class="container mt-100 mt-60">
      ...
      <div class="row g-4 mt-0">
        <div class="col-12">
          <div class="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center w-310px">
              <img src="assets/images/company/facebook-logo.png"
        ...
        <div class="col-12">
          <div class="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center w-310px">
              <img src="assets/images/company/google-logo.png"
                   class="avatar avatar-small rounded shadow p-3 bg-white" alt="">
        ...
        <div class="col-12">
          <div class="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center w-310px">
              <img src="assets/images/company/android.png"
                   class="avatar avatar-small rounded shadow p-3 bg-white" alt="">
        ...
        <div class="col-12">
          <div class="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center w-310px">
              <img src="assets/images/company/spotify.png"
                   class="avatar avatar-small rounded shadow p-3 bg-white" alt="">
        ...
        <div class="col-12">
          <div class="job-post job-post-list rounded shadow p-4 d-md-flex align-items-center justify-content-between position-relative">
            <div class="d-flex align-items-center w-310px">
              <img src="assets/images/company/linkedin.png"
                   class="avatar avatar-small rounded shadow p-3 bg-white" alt="">
        ...
        <div class="col-12">
          <div class="text-center">
            <a href="job-list-one.html" class="btn btn-link primary text-muted">See More Jobs <i
      ...
      <div class="row g-4 align-items-center">
        <div class="col-lg-6 col-md-6 mb-5  order-md-2 order-1">
          <div class="about-right">
            <div class="position-relative shadow rounded img-one">
              <img src="assets/images/about/ab03.jpg" class="img-fluid rounded" alt="work-image">
            </div>

            <div class="img-two shadow rounded p-2 bg-white">
              <img src="assets/images/about/ab04.jpg" class="img-fluid rounded" alt="work-image">
              ...
              <div class="p-4">
                <ul class="list-unstyled text-muted small mb-2">
                  <li class="d-inline-flex align-items-center me-2"><i data-feather="calendar"
                                                                       class="fea icon-ex-sm me-1 text-dark"></i>31st
                    October 2023
                  </li>
                  <li class="d-inline-flex align-items-center"><i data-feather="clock"
                                                                  class="fea icon-ex-sm me-1 text-dark"></i>5
                    min read
                  </li>
                </ul>
                ...
                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                  <li class="list-inline-item me-2"><a href="#" class="btn btn-link primary text-dark">Read
                    Now <i class="mdi mdi-arrow-right"></i></a></li>
                  <li class="list-inline-item"><span class="text-dark">By</span> <a href="#"
                                                                                    class="text-muted link-title">Google</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="p-4">
                ...
                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                  <li class="list-inline-item me-2"><a href="#" class="btn btn-link primary text-dark">Read
                    Now <i class="mdi mdi-arrow-right"></i></a></li>
                  <li class="list-inline-item"><span class="text-dark">By</span> <a href="#"
                                                                                    class="text-muted link-title">Facebook</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="p-4">
                ...
                <ul class="list-unstyled d-flex justify-content-between align-items-center text-muted mb-0 mt-3">
                  <li class="list-inline-item me-2"><a href="#" class="btn btn-link primary text-dark">Read
                    Now <i class="mdi mdi-arrow-right"></i></a></li>
                  <li class="list-inline-item"><span class="text-dark">By</span> <a href="#"
                                                                                    class="text-muted link-title">Linkedin</a>
                  </li>
                </ul>
              </div>
            </div>
