...
var FullCalendar = function (e) {
    ...
    function Dn(e, t, n, r, o, i, a) {
        ...
        var f = p.range.start, h = p.range.end, v = i || e.start || e.eventRange.range.start,
            g = a || e.end || e.eventRange.range.end, m = we(f).valueOf() === we(v).valueOf(),
    ...
    function No(e, t, n, o) {
        var i = o.options, a = o.calendarApi, s = o.pluginHooks.eventSourceDefs[e.sourceDefId], l = ee();
    ...
    var na = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.state, n = this.context, r = e.sections || [], i = this.processCols(e.cols),
                a = this.renderMicroColGroup(i, t.shrinkWidth), s = Ji(e.liquid, n);
