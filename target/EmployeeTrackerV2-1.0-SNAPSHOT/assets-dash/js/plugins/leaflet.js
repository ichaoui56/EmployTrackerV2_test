!(function (t, i) {
    ...
    var Z = {
        on: function (t, i, e) {
            ...
            if (t)
                if ("object" == typeof t) for (var n in t) this._off(n, t[n], i); else for (var o = 0, s = (t = l(t)).length; o < s; o++) this._off(t[o], i, e); else delete this._events;
            return this;
        }, _on: function (t, i, e) {
    ...
    var qi = {
        ...
        flyTo: function (s, r, t) {
            ...
            var g = Date.now(), v = (e(1) - m) / _, y = t.duration ? 1e3 * t.duration : 1e3 * v * 0.8;
    ...
    var Oe = Be.extend({
        options: {smoothFactor: 1, noClip: !1,}, initialize: function (t, i) {
            ...
            if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
                if (this.options.noClip) this._parts = this._rings; else for (var i, e, n, o, s = this._parts, r = 0, a = 0, h = this._rings.length; r < h; r++) for (i = 0, e = (o = this._rings[r]).length; i < e - 1; i++) (n = le(o[i], o[i + 1], t, i, !0)) && ((s[a] = s[a] || []), s[a].push(n[0]), (n[1] === o[i + 1] && i !== e - 2) || (s[a].push(n[1]), a++));
    ...
    var Re = Oe.extend({
        options: {fill: !0,}, isEmpty: function () {
            ...
            if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
                if (this.options.noClip) this._parts = this._rings; else for (var n, o = 0, s = this._rings.length; o < s; o++) (n = ge(this._rings[o], t, !0)).length && this._parts.push(n);
        }, _updatePath: function () {
    ...
    var hn = Me.extend({
        options: {padding: 0.1, tolerance: 0,}, initialize: function (t) {
            ...
            var e = this._map.getZoomScale(i, this._zoom), n = yi(this._container),
                o = this._map.getSize().multiplyBy(0.5 + this.options.padding), s = this._map.project(this._center, i),
